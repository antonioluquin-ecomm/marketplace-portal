...
const VERSION = {
  number: '1.4.79',
  date:   '2026-08-07',
  notes:  'Páginas públicas del seller: corrige el topbar en anchos intermedios (~1200-1700px) — "Cerrar sesión" se caía a una línea flotante desprendida del header, o colisionaba con la nav',
};
...
window.MP_CONFIG = {
  ...
  RESOURCES: [
    ...
    {
      key: "integracion_gestion_asistida",
      label: "Integración Gestión Asistida",
      access: "Interno",
      route: "/internal/estrategia/integracion-gestion-asistida.html"
    },
    {
