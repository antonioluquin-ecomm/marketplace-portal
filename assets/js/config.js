...
const VERSION = {
  number: '1.3.1',
  date:   '2026-07-14',
  notes:  'Se elimina el link duplicado y roto de Configuración en el dropdown de usuario, alineando el patrón al de VTEX Control Center / Project Control Center',
};
