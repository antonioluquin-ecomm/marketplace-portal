...
const VERSION = {
  number: '1.4.68',
  date:   '2026-07-24',
  notes:  'Simulador Económico: tercer pase de consolidación de simuladores.css (familia .col-inputs > .section, 11 subselectores) — sin cambio visual, verificado en 6 anchos',
};
