...
| `internal/hub-operativo.html` | `/internal/hub-operativo.html` | interno | Alta | Hub operativo interno oficial. Etapa 10B agrego regreso a `index.html`, buscador con descripcion y estado sin resultados, aviso sobre `seller_id`, mapa clickeable y ajuste mobile minimo. Pendiente smoke test 10B. |
