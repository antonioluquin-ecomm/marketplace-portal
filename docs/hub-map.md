...
| `sporting-marketplace_hub_v29.html` | `/legacy/root-html-v1/sporting-marketplace_hub_v29.html` | legacy | Alta | Decision 8C: se mantiene intacto como hub operativo historico temporal. No se convierte en alias a `index.html` en V1 porque conserva sidebar, flujo de incorporacion, accesos rapidos, recursos por proceso, buscador, mapa de rutas y grid dinamico. Evaluar post-V1 si se integra en `index.html`, se crea `internal/hub-operativo.html` o se define alias/transicion posterior. |
